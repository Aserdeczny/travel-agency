        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
            ...
            <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <p class="browse d-md-flex">
                    <c:forEach items="${contients}" var="continent">
						<span class="d-flex justify-content-md-center align-items-md-center"><a
                                href='<c:url value="/travels/${continent.name}"/> '>
								<img
...
<section class="ftco-section bg-light">
    <div class="container">
        <div class="row justify-content-start mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate">
                ...
                <h2 class="mb-4">Nasze <strong>najlepsze wycieczki do ${continentPage}</strong></h2>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <c:forEach items="${promotedList}" var="promoted">
                    ...
                    <div class="destination">
                        ...
                        <div class="text p-3">
                            ...
                            <p>Hotel: ${promoted.hotelEntity.name}<br>
                                Ilość miejsc dorosłych: ${promoted.maxAdult}<br>
                                Ilość miejsc dzieci: ${promoted.maxChild}
                            </p>
                            <p class="days">
                                <span>${promoted.fromDate} -> ${promoted.toDate}, ${promoted.days} dni</span></p>
                            <hr>
...
<section class="ftco-section bg-light">
    <div class="container">
        <div class="row justify-content-start mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate">
                ...
                <h2 class="mb-4">Nasze<strong> Wszystkie wycieczki do ${continentPage}</strong></h2>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <c:forEach items="${sortedTravelByContinent}" var="travel">
                <div class="col-sm col-md-6 col-lg ftco-animate">
                    <div class="destination">
                        <a href="#" class="img img-2 d-flex justify-content-center align-items-center"
                           style="background-image: url(<c:url value="/resources/images/destination-3.jpg"/>);">
                        ...
                        <div class="text p-3">
                            ...
                            <p>Hotel: ${travel.hotelEntity.name}<br>
                                Ilość miejsc dorosłych: ${travel.maxAdult}<br>
                                Ilość miejsc dzieci: ${travel.maxChild}
                            </p>
